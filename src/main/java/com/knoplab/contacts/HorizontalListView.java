 ...
 * @author julien
 */
public class HorizontalListView extends ListView implements View{
    ...
    public HorizontalListView (List <Contact> contacts){
  ...
  private class ContactListCell extends ListCell <Contact> {
        ...
        private void onItemChanged(Observable obs, Contact oldValue, Contact newValue){
            ...
            if (newValue == null)
                ...
                this.setGraphic(new HorizontalContactView(newValue));
